...
public class ListingAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        TextView listingListDescription = rowView.findViewById(R.id.listing_list_description);
        TextView listingListToFrom = rowView.findViewById(R.id.listing_list_to_from);
        TextView listingListSize = rowView.findViewById(R.id.listing_list_size);
